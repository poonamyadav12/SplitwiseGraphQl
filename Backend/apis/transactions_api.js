...
export async function updateTransactions(req, res) {
    ...
    await transactionApi.updateTransactions(
...
export async function settleTransactions(req, res) {
    ...
    await transactionApi.settleTransactions(
...
export async function getAllTransactionsForGroup(req, res) {
    ...
    try {
        await transactionApi.getAllTransactionsForGroup(
...
export async function getAllTransactionsForFriend(req, res) {
    ...
    await transactionApi.getAllTransactionsForFriend(
...
export async function getAllTransactionsForUser(req, res) {
    ...
    await transactionApi.getAllTransactionsForUser(
...
export async function addComment(req, res) {
    ...
    await transactionApi.addComment(
...
export async function deleteComment(req, res) {
    ...
    await transactionApi.deleteComment(
